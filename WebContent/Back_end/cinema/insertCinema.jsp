			...
			<div class="col-4">
				<form action="<%= request.getContextPath()%>/CinemaServlet" method="post">
					<table>
						...
						<tr>
							<th>廳院容量</th>
							<td><P id = "p"><c:out value="${cinemaVO.cinema_size}" default="400"/></P></td>
						</tr>
						<tr>
							<th>票價調整</th>
					...
					<input id="hiddentypeinput" type="hidden" name="cinema_type" value="<c:out value="${cinemaVO.cinema_type}"default=""/>">
