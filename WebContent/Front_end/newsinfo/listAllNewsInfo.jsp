                    ...
                    <div class="single-post wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="post-thumb">
                        	<c:set var="mimg" value="${newsinfoVO.news_pic}" />
					            ...
					            %>
	            <a href="<%=request.getContextPath()%>/Front_end/newsinfo/newsinfo.do?action=getOne_For_Display_Front&news_no=${newsinfoVO.news_no}"><img id="newspic" class="news2_pic" src="data:image/jpg;base64,<%=news_pic%>"></a>
	            <!-- Overlay Text -->
                        </div>
                        <!-- Post Content -->
