...
CREATE SEQUENCE SESSIONS_SEQ
 ...
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000001,'CINEMA001','2019-03-29 06-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000002,'CINEMA002','2019-03-29 08-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000003,'CINEMA003','2019-03-29 10-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000004,'CINEMA004','2019-03-29 12-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000005,'CINEMA005','2019-03-29 14-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000001,'CINEMA006','2019-03-29 16-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000002,'CINEMA007','2019-03-29 18-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000003,'CINEMA008','2019-03-29 20-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000004,'CINEMA009','2019-03-29 22-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000005,'CINEMA010','2019-03-29 01-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000001,'CINEMA011','2019-03-29 04-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000002,'CINEMA012','2019-03-30 06-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000003,'CINEMA013','2019-03-30 08-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000004,'CINEMA014','2019-03-30 10-00-00','座位格式未定',400);
 INSERT INTO SESSIONS VALUES ('TEST_SESSIONS'||LPAD(SESSIONS_SEQ.NEXTVAL, 7, '0'),00000005,'CINEMA015','2019-03-30 12-00-00','座位格式未定',400);
