...
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'A123456','123456','DAVID','POKENMONMASTER',1,TO_DATE('1981-11-17','YYYY-MM-DD'),'台北市天母區天龍路1號','pokoman1314520@gmail.com',null,null,null , DEFAULT, 500,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'B123456','12345','PETER','WU-GOD',1,TO_DATE('1971-01-08','YYYY-MM-DD'),'台北市中正區大神路1號','123JAVAsoeasy@gmail.com',null ,null,null, DEFAULT, 1500,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'C123456','Z123456','AGEA','AEN',0,TO_DATE('2000-03-05','YYYY-MM-DD'),'新北市中正區路1號','s1022546@gmail.com',null ,null,null, TO_DATE('2019-02-01','YYYY-MM-DD'), 5500,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'D123456','a23456','BOBO','BO',1,TO_DATE('2005-04-28','YYYY-MM-DD'),'桃園市中壢區中央路1號','a7513323@gmail.com',null ,null,null, TO_DATE('2019-01-03','YYYY-MM-DD'), 2500,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'E123456','b12456','CICI','GAY',1,TO_DATE('1977-05-06','YYYY-MM-DD'),'新竹縣湖口鄉湖口路1號','s78423@gmail.com',null ,null,null, TO_DATE('2019-01-13','YYYY-MM-DD'), 100,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'F123456','c23456','DOG','NOGIRLFRIEND',1,TO_DATE('1981-10-17','YYYY-MM-DD'),'苗栗市草莓區樂桃路1號','d89896@gmail.com',null,null,null , TO_DATE('2019-01-20','YYYY-MM-DD'), 50,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'G123456','d23456','SOPIYA','LONG',0,TO_DATE('2000-10-10','YYYY-MM-DD'),'台中市霧峰區中央路1號','f00000@gmail.com',null ,null,null, TO_DATE('2019-01-01','YYYY-MM-DD'), 700,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'H123456','e23456','GAGA','LADY',0,TO_DATE('1994-05-23','YYYY-MM-DD'),'彰化縣彰化市精誠路1號','g7897798@gmail.com',null ,null,null, TO_DATE('2019-02-03','YYYY-MM-DD'), 600,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'I123456','f23456','WANG','WANG40',1,TO_DATE('1997-03-27','YYYY-MM-DD'),'雲林縣雲林市虎尾路1號','q026554564@gmail.com',null ,null,null, TO_DATE('2019-02-03','YYYY-MM-DD'), 400,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'J123456','g23456','CHEN','C',1,TO_DATE('1988-11-20','YYYY-MM-DD'),'嘉義市火雞路1號','avc78789@gmail.com',null ,null,null, TO_DATE('2019-02-03','YYYY-MM-DD'), 200,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'K123456','h23456','JIA','JIAJIA',0,TO_DATE('1959-01-01','YYYY-MM-DD'),'台南市赤崁區中央路1號','fff48798@gmail.com',null,null,null , TO_DATE('2019-02-03','YYYY-MM-DD'), 1500,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'L123456','h23456','WILLIAM','WIN',0,TO_DATE('1999-07-22','YYYY-MM-DD'),'高雄市鳳山區韓流路1號','gggg7879@gmail.com',null,null,null , TO_DATE('2019-02-03','YYYY-MM-DD'), 1000,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'N123456','j23456','PEN','PP',1,TO_DATE('1989-10-23','YYYY-MM-DD'),'花蓮縣花蓮市中央路1號','fdsf5466@gmail.com',null,null,null , TO_DATE('2019-02-03','YYYY-MM-DD'), 3000,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'O123456','u23456','ANDY','NICO',1,TO_DATE('1995-08-07','YYYY-MM-DD'),'台東縣知本鄉溫泉路1號','NICO520@gmail.com',null,null,null , TO_DATE('2019-02-03','YYYY-MM-DD'), 4000,0);
INSERT INTO MEMBER VALUES ('M'||LPAD(to_char(MEMBER_seq.NEXTVAL),6,'0') , 'P123456','i23456','NICO','LOVE',0,TO_DATE('1995-06-09','YYYY-MM-DD'),'台東縣綠島鄉海岸路1號','ANDY520@gmail.com',null,null,null , TO_DATE('2019-02-03','YYYY-MM-DD'), 5000,0);
...
CONSTRAINT GRO_ALL_SES_FK FOREIGN KEY(SESSION_NO)
...
CONSTRAINT TIC__SES_FK FOREIGN KEY(SESSION_NO)
    REFERENCES SESSIONS(SESSION_NO),
...
INSERT INTO MOVIETICKET VALUES (MOVIETICKET_seq.NEXTVAL, 'TO_000005','5', NULL, 1, 's78423@gmail.com');
INSERT INTO MOVIETICKET VALUES (MOVIETICKET_seq.NEXTVAL, 'TO_000006','6', NULL, 0, 'd89896@gmail.com');
INSERT INTO MOVIETICKET VALUES (MOVIETICKET_seq.NEXTVAL, 'TO_000007','7', NULL, 0, 'f00000@gmail.com');
INSERT INTO MOVIETICKET VALUES (MOVIETICKET_seq.NEXTVAL, 'TO_000008','8', NULL, 1, 'g7897798@gmail.com');
INSERT INTO MOVIETICKET VALUES (MOVIETICKET_seq.NEXTVAL, 'TO_000009','9', NULL, 1, 'q026554564@gmail.com');
INSERT INTO MOVIETICKET VALUES (MOVIETICKET_seq.NEXTVAL, 'TO_000010','10', NULL, 0, 'avc78789@gmail.com');
INSERT INTO MOVIETICKET VALUES (MOVIETICKET_seq.NEXTVAL, 'TO_000011','11', NULL, 0, 'fff48798@gmail.com');
INSERT INTO MOVIETICKET VALUES (MOVIETICKET_seq.NEXTVAL, 'TO_000012','12', NULL, 1, 'gggg7879@gmail.com');
INSERT INTO MOVIETICKET VALUES (MOVIETICKET_seq.NEXTVAL, 'TO_000013','13', NULL, 1, 'fdsf5466@gmail.com');
INSERT INTO MOVIETICKET VALUES (MOVIETICKET_seq.NEXTVAL, 'TO_000014','14', NULL, 0, 'NICO520@gmail.com');
INSERT INTO MOVIETICKET VALUES (MOVIETICKET_seq.NEXTVAL, 'TO_000015','15', NULL, 0, 'ANDY520@gmail.com');
