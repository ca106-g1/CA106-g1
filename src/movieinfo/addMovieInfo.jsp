...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			...
			<td>
				<h4>
					<a href="select_page.jsp"><img src="images/popcorn.jpg"
...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/Expansion/jquery.datetimepicker.css" />
<script src="<%=request.getContextPath()%>/Expansion/jquery.js"></script>
<script	src="<%=request.getContextPath()%>/Expansion/jquery.datetimepicker.full.js"></script>
